...
->MEH
*Non, désolé... Le foot, c'est pas trop mon truc, et je dois aller en cours... Mais merci.
->NOPE


=== OMGYES ===
-SoccerKid: Ben parfait, ramène ton cul alors, on va te coller une raclée, ha ha !
->END

=== MEH ===
-SoccerKid: Ohhh, allez, fais pas genre ça te reste sur la conscience, on s'en fout. J'y retourne, j'espère t'y voir, hein ! //Sort de l'écran de jeu, flag pour "Aller au foot mais moyen envie."
->END

=== NOPE ===
-SoccerKid: Hmmm, bon... Si tu préfère te faire chier en cours, je suppose que c'est ton problème... Allez, ciao...
->END